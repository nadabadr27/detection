...
import 'package:detection/modules/showdoctor_screen/resultdetection/resultdetection.dart';
...
class doctorDetect extends StatefulWidget {
  @override
  State<doctorDetect> createState() => _doctorDetectState();
}
class _doctorDetectState extends State<doctorDetect> {
      ...
      if (_image != null) {
        ...
        if (_classValue != null) {
          ...
          Navigator.of(context).push(MaterialPageRoute(
              builder: (context) => doctorresult (responseValue: _classValue!)));
        } else {
          ScaffoldMessenger.of(context).showSnackBar(
